...
void testing(void) {
	printf("hello from c(xx) via pybind11\n");
}

ExampleClass::ExampleClass() {
	printf("ExampleClass constructor variant A\n");
}
...
void ExampleClass::OverloadedMethod() {
	printf("ExampleClass overloaded method variant A\n");
}
...
void ExampleClass::Method() {
	printf("ExampleClass method\n");
}

ExampleClass::~ExampleClass() {
	printf("ExampleClass destructor\n");
}
